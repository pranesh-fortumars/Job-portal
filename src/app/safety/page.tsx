      ...
      <main className="flex-grow py-12 px-4 max-w-5xl mx-auto space-y-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
               {[
                { title: t.employerRule1Title, desc: t.employerRule1Desc || "You must ask for a valid Government ID (Aadhaar, Voter ID, etc.) and verify it before confirming any hire.", icon: "🆔" },
        ...
        <Card className="border-none shadow-2xl bg-destructive text-destructive-foreground rounded-[2.5rem] overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="bg-white/10 p-8 md:p-12 flex flex-col justify-center space-y-6 backdrop-blur-md border-l border-white/10">
               <div className="space-y-4">
                  <div className="bg-white p-6 rounded-2xl flex items-center justify-between group cursor-pointer" onClick={() => window.open('https://wa.me/917305505311')}>
                    <div>
                      <p className="text-[10px] font-bold text-destructive uppercase tracking-widest">Chat with us</p>
                  ...
                  <div className="bg-white p-6 rounded-2xl flex items-center justify-between group cursor-pointer" onClick={() => window.open('tel:+919025404014')}>
                    <div>
                      <p className="text-[10px] font-bold text-destructive uppercase tracking-widest">Call Official Support</p>
                      <p className="text-lg font-extrabold text-primary">{t.phoneSupport}</p>
                    </div>
