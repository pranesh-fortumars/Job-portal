    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="fixed inset-0 z-[100] bg-white flex flex-col items-center justify-center animate-out fade-out duration-500 fill-mode-forwards pointer-events-none">
        <div className="flex flex-col items-center gap-6">
          <div className="w-40 h-40 bg-primary/5 rounded-[2.5rem] flex items-center justify-center shadow-inner animate-pulse overflow-hidden">
            <AppLogo section="splash" width={140} height={140} priority />
          </div>
          <div className="space-y-1 text-center">
            <h1 className="text-3xl font-bold text-primary tracking-tight font-headline">{BRANDING.siteName}</h1>
            <p className="text-[12px] text-muted-foreground uppercase font-bold tracking-[0.3em] animate-pulse">Connecting Industrial Talent...</p>
          </div>
        </div>
      </div>
